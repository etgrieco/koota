import { createUniverse, createWorldFromUniverse, Universe } from 'koota/universe';
...
function movePositions(world: World) {
...
const TEST_UNIVERSES_SPAWNED = 32;
function main() {
	...
	for (const id of sessionIds) {
		...
		requestAnimationFrame(function loop(nowTime) {
			movePositions(gameSession.worlds.mainGameWorld);
